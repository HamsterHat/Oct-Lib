...
public class RocketControlCenter extends PayloadBlock {
    ...
    public String targetName = "Another Planet", targetDesc = "No data";

    public Sound rocketConstructSound = Sounds.acceleratorConstruct, countdownSound = Sounds.none, loopSound = Sounds.none;
    public SectorPreset sector;
    public CoreBlock launchBlock;
    ...
    public class RocketControlCenterBuild extends PayloadBlockBuild<BuildPayload> implements LaunchAnimator {
        ...
        public void beginLaunch(boolean launching) {
            ...
            Time.run(mergeDuration, () -> {
                OctoFx.rocketMerge.at(x, y, 0f, this);
            ...
            Time.run(chargeDuration - (60f * 10f), () -> {
                for (int i = 0; i < 10; i++) {
                    ...
                    int finalI = i;
                    Time.run(i * 60f, () -> {
                        OctoFx.countdownNumber.at(x, y + countdownHeightOffset, number, this);
