...
public class RocketLaunchPad extends PayloadBlock {
    ...
    public void setStats() {
        super.setStats();
        stats.add(OctoStat.inputEdge, StatValues.content(requiredBlockEdge));
        stats.add(OctoStat.inputCorner, StatValues.content(requiredBlockCorner));
    }
